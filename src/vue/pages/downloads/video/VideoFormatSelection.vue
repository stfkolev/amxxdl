<template>
    <div class="format-selection">
        ...
        <drop-down-selection v-if="['video', 'audio/video'].includes(content)"
                             ...
                             :title="resolution || 'избери качество'"
                             v-model="resolution"
        ...
        <drop-down-selection v-if="content"
                             ...
                             :items="extensions"
                             :title="format || 'Избери файлов формат'"
                             v-model="format"/>
        ...
        methods: {
            ...
            startDownload() {
                if (this.sources) {
                    ...
                    console.error('[ИЗТЕГЛЯНЕ] Пробвахте изтегляне без посочен адрес', this.format, this.resolution, this.bitrate);
                }
            }
        }
    };
