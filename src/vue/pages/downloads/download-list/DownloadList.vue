        ...
        <template v-if="downloads.length">
            ...
            <div class="header">
                ...
                <div :class="{actions: 1, visible: someInProgress || somePaused}">
                    <button class="action-red" @click="cancelAll">Прекъсни всички</button>
        ...
        methods: {
            ...
            cancelAll() {
                ...
                this.$store.commit('dialogbox/show', {
                    title: 'Прекратяване на всички изтегляния',
                    text: 'Сигурен ли сте, че искате да прекратите всички изтегляния?',
                    buttons: [
                        {type: 'cancel', text: 'Да'},
                        {type: 'accept', text: 'Не'}
                    ],
