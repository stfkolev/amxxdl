    ...
    <div class="downloads">
        ...
        <div class="header">
            ...
            <div class="url-input">
                ...
                <input v-model="input"
                       placeholder="Въведи видео, плейлист чрез id/url"
                       type="text"
            ...
            <div v-if="videoAndPlaylist && !loading" class="recognition-type">
                <button :class="{active: type === 'video'}" @click="chooseType('video')">Видео</button>
                <button :class="{active: type === 'playlist'}" @click="chooseType('playlist')">Плейлист</button>
            </div>
