<template>
    <div class="format-selection">
        ...
        <drop-down-selection v-if="['video', 'audio/video'].includes(content)"
                             ...
                             :title="videoQuality || 'Избери видео качество'"
        ...
        <drop-down-selection v-if="['audio', 'audio/video'].includes(content)"
                             ...
                             :items="availableQualities"
                             :title="audioQuality || 'Избери аудио качество'"
        ...
        <drop-down-selection v-if="content"
                             ...
                             :items="extensions"
                             :title="format || 'Избери формат на файла'"
                             v-model="format"/>
    ...
    export default {
        ...
        data() {
            return {
                ...
                availableQualities: ['високо', 'средно', 'ниско'],
                content: null,
                audioQuality: null,
                videoQuality: null,
                format: null
        ...
        methods: {
            ...
            videoQualityFilter(v) {
                return `${v} видео качество`;
            },

            audioQualityFilter(v) {
                return `${v} аудио качество`;
            },
            ...
            startDownload() {
                ...
                for (const video of videos) {
                    ...
                    if (!sources) {
                        ...
                        /* eslint-disable no-console */
                        console.error(`Нищо не е открито за ${video.title}`);
                        continue;
                    }
