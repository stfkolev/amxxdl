<template>
    <div class="settings">
        ...
        <section class="paths">
            ...
            <div class="field">
                <text-input-field v-model="current.downloadDirectory" placeholder="Път за изтегляне"/>
                <button class="action-green" @click="openFolder(current.downloadDirectory)">Отвори папката</button>
            </div>

            <div class="field">
                <text-input-field v-model="current.temporaryDirectory" placeholder="Временен път"/>
                <button class="action-green" @click="openFolder(current.temporaryDirectory)">Отвори папката</button>
            </div>

            <button :class="{visible: hasChanged}" @click="applySettings">Запази</button>
        </section>
        ...
        <section class="checkboxes">
            ...
            <div class="item">
                ...
                <span>Създай директория за всеки канал.</span>
            </div>

            <div class="item">
                <checkbox v-model="current.createPlaylistDirectory"/>
                <span>Създай директория с името на плейлиста.</span>
            </div>

            <!-- TODO: Implement -->
            <!--<div class="item">
                <checkbox v-model="current.lockDownloadSettings"/>
                <span>Запази последните настройки и ги сложи на бъдещи.</span>
            </div>-->
        ...
        <section class="front-page">
            ...
            <!-- Edit shown channels -->
            <h3>Канали, които да се показват в началната страница</h3>
            <tag-input-field v-model="current.homeVideoChannels"
                             placeholder="Добави id на канал"/>
